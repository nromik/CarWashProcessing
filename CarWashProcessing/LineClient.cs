...
#pragma warning disable // Disable all warnings
    ...
    public partial class Client
    {
        ...
        public System.Threading.Tasks.Task<bool> ApiTaskPostAsync(int? taskId, TaskInfo info)
        {
            return ApiTaskPostAsync(taskId, info, System.Threading.CancellationToken.None);
        }

        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<bool> ApiTaskPostAsync(int? taskId, TaskInfo info, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Task?");
            if (taskId != null)
            {
                urlBuilder_.Append("taskId=").Append(System.Uri.EscapeDataString(ConvertToString(taskId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
    ...
    public partial class TaskInfo : System.ComponentModel.INotifyPropertyChanged
    {
        private bool? _needWorker;
        private int? _duration;

        [Newtonsoft.Json.JsonProperty("needWorker", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool? NeedWorker
        {
            get { return _needWorker; }
            set
            {
                if (_needWorker != value)
                {
                    _needWorker = value;
        ...
        public static TaskInfo FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TaskInfo>(data);
        }
